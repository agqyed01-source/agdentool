...
import { FeaturedCategories } from '../components/FeaturedAndFooter';
import { CategoryBar, ProductGrid } from '../components/ProductSection';
...
export const Home = () => {
  ...
  return (
    <>
      <Seo 
        title={isHome ? "Premium Dental Supplies & Equipment" : slug ? `Products in ${slug}` : "Search Results"}
        ...
        jsonLd={{
          ...
          "potentialAction": {
            "@type": "SearchAction",
            "target": "https://www.yourdentalsite.com/search?q={search_term_string}",
