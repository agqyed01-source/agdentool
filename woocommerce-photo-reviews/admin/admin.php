        ...
        <div class="wrap">
            ...
            <div class="vi-ui styled fluid accordion">
                ...
                <div class="content">
                    <div class="vi-ui positive message">
                        <ul class="list">
                            <li><?php echo wp_kses_post( __( 'Overall rating shortcode <strong>[wc_photo_reviews_overall_rating_html product_id="" overall_rating_enable="on" rating_count_enable="on" average_rating_style=""]</strong> is used to display overall rating', 'woocommerce-photo-reviews' ) ) ?></li>
                            ...
                            <li><?php echo wp_kses_post( __( 'Review form shortcode <strong>[woocommerce_photo_reviews_form product_id="" hide_product_details="" hide_product_price="" type="popup" button_position="center" upload_button_style="2"]</strong> can be used for single product page or review page of reminder email.', 'woocommerce-photo-reviews' ) ) ?></li>
                            <li><?php echo wp_kses_post( __( 'Reviews shortcode is used to display all reviews or specific reviews of some products or categories. Usage with all available arguments: <strong>[wc_photo_reviews_shortcode comments_per_page="12" cols="3" cols_mobile="1" use_single_product="on" cols_gap="" products="" grid_bg_color="" grid_item_bg_color="" grid_item_border_color="" text_color="" star_color="" product_cat="" order="desc" orderby="comment_date" show_product="on" filter="on" pagination="on" pagination_ajax="on" pagination_pre="" pagination_next="" pagination_style="" pagination_position="" pagination_end="" loadmore_button="off" filter_default_image="off" filter_default_verified="off" filter_default_rating="" custom_css="" ratings="" mobile="on" is_slide="" style="masonry" masonry_popup="review" enable_box_shadow="on" full_screen_mobile="on" overall_rating="off" rating_count="off" average_rating_style="" only_images="off" image_popup="below_thumb"]</strong>', 'woocommerce-photo-reviews' ) ) ?></li>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="vi-ui toggle checkbox">
                                    ...
                                    <label><?php esc_html_e( 'Compatible with WPML, Polylang, TranslatePress', 'woocommerce-photo-reviews' ); ?></label>
                                </div>
                            </td>
                        </tr>
						<?php
                ...
                <div class="vi-ui bottom tab segment" data-tab="photo">
                    <div class="vi-ui segment">
                        <table class="form-table">
                            ...
                            <tr>
                                <th>
                                    <label for="reviews_order_new_tab"><?php esc_html_e( 'Disable reviews orders new tab', 'woocommerce-photo-reviews' ) ?></label>
                                </th>
					...
					if (!in_array($frontend_style,[1,3,4]) ) {
                    ...
                    <div class="vi-ui segment">
                        <table class="form-table">
							...
							?>
                            <tr class="<?php echo esc_attr( !in_array($frontend_style ,[5,6]) ? $masonry_options_class.' style-6-options style-5-options': 'masonry-options style-6-options style-5-options' ); ?>">
                                <th>
                            ...
                            <tr>
                                ...
                                <td>
									<?php
									$product_gallery_enable = $this->settings->get_params( 'photo', 'product_gallery_enable' );
									?>
                                    <select name="product_gallery_enable" id="wcpr-filter-default-rating" class="wcpr-filter-default-rating vi-ui fluid dropdown">
                                        <option value="0" <?php selected( $product_gallery_enable, '0' ) ?>><?php esc_html_e( 'None', 'woocommerce-photo-reviews' ); ?></option>
                                        <option value="1" <?php selected( $product_gallery_enable, '1' ) ?>><?php esc_html_e( 'Show one random image of the Product Gallery', 'woocommerce-photo-reviews' ); ?></option>
                                        <option value="2" <?php selected( $product_gallery_enable, '2' ) ?>><?php esc_html_e( 'Only show first image of the Product Gallery', 'woocommerce-photo-reviews' ); ?></option>
                                    </select>
                                    <p class="description">
										<?php esc_html_e( 'If a review has no images or videos, add one from your Product Gallery using this option.', 'woocommerce-photo-reviews' ); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr class="<?php echo esc_attr( !in_array($frontend_style ,[5]) ? $masonry_options_class.' style-5-options': 'masonry-options style-5-options' ); ?>">
                                <th>
	...
	public function save_settings() {
		...
		$args          = array(
			...
			'photo'                          => array(
				...
				'product_gallery_enable'          => isset( $_POST['product_gallery_enable'] ) ? sanitize_text_field( $_POST['product_gallery_enable'] ) : '0',
			...
			'reviews_order_new_tab'          => isset( $_POST['reviews_order_new_tab'] ) ? sanitize_text_field( $_POST['reviews_order_new_tab'] ) : "",
