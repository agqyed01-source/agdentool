...
if ( $type === 'popup' ) {
	...
	$button_close  = sprintf( '<div class="woocommerce-photo-reviews-form-main-top"><span class="popup-title">%s</span><span class="woocommerce-photo-reviews-form-main-close"></span></div>',
                            ...
                            <div class="wcpr_review_form_wrapper">
                                <div class="wcpr_review_form">
									...
									$comment_form = array(
										...
										'wcpr_upload_button_style'          => $upload_button_style??'',
									);
                            ...
                            <div class="wcpr_review_form_wrapper">
                                <div class="wcpr_review_form">
									...
									$comment_form = array(
										...
										'label_submit'        => esc_html__( 'Submit', 'woocommerce-photo-reviews' ),
										'class_submit'         => 'submit wcpr-comment-form-submit viwcpr-review-order-submit',
										'logged_in_as'        => '',
										'comment_field'       => '',
										'id_form'             => 'wcpr_comment_form',
										'class_form'          => 'comment-form wcpr-comment-form',
